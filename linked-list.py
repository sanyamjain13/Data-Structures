...
class Linkedlist:
    ...
    def insertNodeRecursive(self,current,currentNext,value):
        ...
        if current.data<value and currentNext.data>value:
            temp=current
            temp.next=Node(value)
            temp.next.next=currentNext             
        
		else:
            return self.insertNodeRecursive(current.next,current.next.next,value)
...
if __name__=='__main__':
    ...
    while True:
        ...
        if ch==1:
            ...
            for i in range(number): 
                value=int(input())
                l.insertNodeRecursive(None,l.head.next,value)
